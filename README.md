1. **O elemento `<footer>`** implementa um rodapé, onde está sendo implementado nesse contexto, um formulário para enviar um email aos desenvolvedores, e o copyright do site. O `footer` foi dividido em duas partes:
